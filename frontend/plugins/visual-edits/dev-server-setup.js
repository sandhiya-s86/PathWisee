      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="visual-edit" -c user.email="noreply@pathwise.app" add "${targetFile}"`);
            execSync(`git -c user.name="visual-edit" -c user.email="noreply@pathwise.app" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
